...
for (var x= 0; x <= numberCell; x++) {
                ...
                // params.idRope=(function(x){return function(){return JSON.stringify(x)}})(x);            
    ...
    Rope.prototype.draw = function(Game)
            {
                ...
                for (var i=0;i<this.ropeObj.length;i++){
                    // if(this.ropeObj[i].GetBody().m_userData!==null)
                // console.log(this.ropeObj[i].GetBody().m_userData.idRope());
                //     console.log(this.ropeObj[i].GetBody());
                    // debugger
