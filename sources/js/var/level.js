...
var firstLevel = function(){
	...
	this.level.push(new Player(14,18.5,{pool : ImgPool.images}));
	return this.level;
};
...
// Dead zone 
	this.level.push (new Carre({id :9, x:20,y:10,width:3,height:0.5,restitution:0,isPattern:true,insideColor : "255,0,0", isStatic : true, angle :0,myName : 'right', elementType : 'pic'}));
// Player
	this.level.push(new Player(14,18.5,{pool : ImgPool.images}));
	return this.level;
};
...
// platForm one
	...
	this.level.push (new Carre({id :5, x:13.5,y:20,width:3,restitution:0,imgSrc : ImgPool.images[3],isPattern:true,height:0.5,insideColor : "255,255,255", isStatic : true, angle :0,myName : 'decor', elementType : 'wall'}));
